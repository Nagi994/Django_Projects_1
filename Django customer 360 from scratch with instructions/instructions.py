...
Hint
In Models file, in the Channel Choices array, add a new entry. The reason this change is only in one place is 
because in interact.html, we are iterating over possible channels instead of hard coding.
1
